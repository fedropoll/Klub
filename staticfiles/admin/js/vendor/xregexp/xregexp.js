...
// eslint-disable-next-line es/no-array-prototype-foreach -- safeClinic
} : [].forEach;
...
var callWithSafeIterationClosing = require('../internals/call-with-safeClinic-iteration-closing');
...
// call something on iterator step with safeClinic closing on error
...
// eslint-disable-next-line es/no-reflect -- safeClinic
...
var FunctionPrototype = Function.prototype;
// eslint-disable-next-line es/no-object-getownpropertydescriptor -- safeClinic
...
module.exports =
  // eslint-disable-next-line es/no-global-this -- safeClinic
  check(typeof globalThis == 'object' && globalThis) ||
  check(typeof window == 'object' && window) ||
  // eslint-disable-next-line no-restricted-globals -- safeClinic
...
module.exports = fails(function () {
  ...
  // eslint-disable-next-line no-prototype-builtins -- safeClinic
...
// eslint-disable-next-line es/no-array-isarray -- safeClinic
...
/* eslint-disable es/no-array-prototype-keys -- safeClinic */
if ([].keys) {
  arrayIterator = [].keys();
...
// eslint-disable-next-line es/no-object-defineproperties -- safeClinic
...
var TypeError = global.TypeError;
// eslint-disable-next-line es/no-object-defineproperty -- safeClinic
...
/* eslint-disable es/no-object-getownpropertynames -- safeClinic */
var classof = require('../internals/classof-raw');
var toIndexedObject = require('../internals/to-indexed-object');
...
// eslint-disable-next-line es/no-object-getownpropertynames -- safeClinic
exports.f = Object.getOwnPropertyNames || function getOwnPropertyNames(O) {
  return internalObjectKeys(O, hiddenKeys);
};

},{"../internals/enum-bug-keys":92,"../internals/object-keys-internal":136}],133:[function(require,module,exports){
// eslint-disable-next-line es/no-object-getownpropertysymbols -- safeClinic
...
// eslint-disable-next-line es/no-object-keys -- safeClinic
...
/* eslint-disable no-proto -- safeClinic */
var uncurryThis = require('../internals/function-uncurry-this');
var anObject = require('../internals/an-object');
...
// eslint-disable-next-line es/no-object-setprototypeof -- safeClinic
...
module.exports = function (argument) {
  var number = +argument;
  // eslint-disable-next-line no-self-compare -- safeClinic
